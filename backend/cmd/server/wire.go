...
func provideCleanup(
	...
	heartbeatProvisioning *service.HeartbeatProvisioningService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"HeartbeatProvisioningService", func() error {
				if heartbeatProvisioning != nil {
					heartbeatProvisioning.Stop()
				}
				return nil
			}},
