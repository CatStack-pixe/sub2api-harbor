...
// QueryProxyGroup queries the proxy_group edge of a Proxy.
func (c *ProxyClient) QueryProxyGroup(_m *Proxy) *ProxyGroupQuery {
...
func (c *ProxyGroupClient) Hooks() []Hook {
	return c.hooks.ProxyGroup
}

// Interceptors returns the client interceptors.
func (c *ProxyGroupClient) Interceptors() []Interceptor {
	return c.inters.ProxyGroup
}
