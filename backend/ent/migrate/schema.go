...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "grok", "antigravity", "kimi", "zhipu", "deepseek", "sensenova", "minimax", "opencode_go", "tierflow"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "global_prompt_enabled", Type: field.TypeBool, Default: false},
		{Name: "global_prompt", Type: field.TypeString, Size: 32768, Default: "", SchemaType: map[string]string{"postgres": "text"}},
