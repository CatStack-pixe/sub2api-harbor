...
// 请求头覆写（header override）：对 Anthropic / OpenAI / Agnes / DeepSeek 平台
// 的 api_key 账号以及 Grok 平台的 api_key / oauth 账号生效。
...
// Anthropic / OpenAI / Agnes / DeepSeek 仅开放 api_key 账号；Grok 额外开放 oauth 账号——
...
func (a *Account) IsHeaderOverrideEligible() bool {
	...
	switch a.Platform {
	case PlatformAnthropic, PlatformOpenAI, PlatformAgnes, PlatformDeepSeek, PlatformNvidia, PlatformTokenRhythm, PlatformKimi, PlatformChatAnywhere, PlatformGLM:
