...
const (
	...
	// 配额模式引入的 provider（antigravity/kimi/zhipu/deepseek/sensenova）：
	// antigravity 无探活 adapter（仅配额），其余 provider 复用 OpenAI 兼容探活。
...
var (
	...
	ErrChannelMonitorInvalidProvider = infraerrors.BadRequest(
		"CHANNEL_MONITOR_INVALID_PROVIDER", "provider must be one of openai/anthropic/gemini/grok/antigravity/kimi/zhipu/deepseek/sensenova/minimax",
	)
