		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"agnes":{"daily":null,"weekly":null,"monthly":null},"anthropic":{"daily":null,"weekly":null,"monthly":null},"antigravity":{"daily":null,"weekly":null,"monthly":null},"chatanywhere":{"daily":null,"weekly":null,"monthly":null},"dashscope":{"daily":null,"weekly":null,"monthly":null},"deepseek":{"daily":null,"weekly":null,"monthly":null},"gemini":{"daily":null,"weekly":null,"monthly":null},"glm":{"daily":null,"weekly":null,"monthly":null},"grok":{"daily":null,"weekly":null,"monthly":null},"kimi":{"daily":null,"weekly":null,"monthly":null},"minimax":{"daily":null,"weekly":null,"monthly":null},"modelscope":{"daily":null,"weekly":null,"monthly":null},"nvidia":{"daily":null,"weekly":null,"monthly":null},"openai":{"daily":null,"weekly":null,"monthly":null},"opencode_go":{"daily":null,"weekly":null,"monthly":null},"sensenova":{"daily":null,"weekly":null,"monthly":null},"senseaudio":{"daily":null,"weekly":null,"monthly":null},"tierflow":{"daily":null,"weekly":null,"monthly":null},"tokenrhythm":{"daily":null,"weekly":null,"monthly":null},"volcengine":{"daily":null,"weekly":null,"monthly":null},"zhipu":{"daily":null,"weekly":null,"monthly":null}},
...
func (stubProxyRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, filters service.ProxyListFilters) ([]service.Proxy, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}

func (stubProxyRepo) ListWithFiltersAndAccountCount(ctx context.Context, params pagination.PaginationParams, filters service.ProxyListFilters) ([]service.ProxyWithAccountCount, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
