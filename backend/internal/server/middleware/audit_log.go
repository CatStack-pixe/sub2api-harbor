...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/tokenrhythm/session/resolve":          "admin.tokenrhythm.session.resolve",
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/tokenrhythm/session/resolve":            {},
	"POST /api/v1/admin/tokenrhythm/api-keys":                   {},
	"POST /api/v1/admin/tokenrhythm/api-keys/list":              {},
	"POST /api/v1/admin/tokenrhythm/api-keys/:id/disable":       {},
	"POST /api/v1/admin/tokenrhythm/api-keys/:id/delete":        {},
