...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok agnes deepseek nvidia tokenrhythm kimi zhipu chatanywhere glm modelscope dashscope minimax volcengine sensenova tierflow opencode_go composite"`
...
type CompositeRouteRequest struct {
	...
	TargetPlatform string `json:"target_platform" binding:"required,oneof=anthropic openai gemini antigravity grok agnes deepseek nvidia tokenrhythm kimi zhipu chatanywhere glm modelscope dashscope minimax volcengine sensenova tierflow opencode_go"`
