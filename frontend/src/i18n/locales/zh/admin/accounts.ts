export default {
    accounts: {
      ...
      tokenrhythm: {
        ...
        sessionHint: '使用所选代理向 TokenRhythm 验证会话，自动生成余额查询 Cookie 和邀请链接；Sess 不会保存。',
        resolveSession: '生成 Cookie 与邀请链接',
        resolvingSession: '正在生成',
        sessionResolved: 'TokenRhythm Cookie 和邀请链接已生成',
        sessionResolveFailed: 'TokenRhythm Sess 验证失败',
        inviteLink: '邀请链接',
        inviteLinkOpen: '打开邀请链接',
        inviteCode: '邀请码：{code}',
