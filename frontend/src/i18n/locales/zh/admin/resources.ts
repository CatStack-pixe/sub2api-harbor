export default {
    ...
    proxies: {
      ...
      allStatus: '全部状态',
      searchProxies: '搜索代理...',
      allProxyGroups: '全部代理分组',
      ungrouped: '未分组',
      proxyGroup: '代理分组',
      manageGroups: '管理分组',
      batchMove: '移动',
      batchMoveTitle: '移动选中代理',
      batchMoveDescription: '将选中的 {count} 个代理移动到指定代理分组。',
      batchMoveDone: '已移动 {count} 个代理',
      batchMoveFailed: '移动代理失败',
      batchMoveLimit: '每次最多移动 5000 个代理',
      move: '移动',
      moving: '移动中...',
      resultLimitHint: '当前显示 {total} 个匹配项中的前 {shown} 个，请继续搜索以缩小范围。',
      batchTestLimitExceeded: '请将当前筛选结果缩小到 {count} 个以内再批量测试',
      protocols: {
        http: 'HTTP',
        https: 'HTTPS',
        socks5: 'SOCKS5',
      ...
      proxyGroups: {
        ...
        inactiveCount: '停用 {count} 个',
        created: '代理分组创建成功',
        updated: '代理分组更新成功',
        deleted: '代理分组已删除，组内代理已移至未分组',
        createFailed: '创建代理分组失败',
        updateFailed: '更新代理分组失败',
        deleteFailed: '删除代理分组失败',
        loadFailed: '加载代理分组失败',
        deleteTitle: '删除代理分组',
        deleteConfirm: "确定删除代理分组 '{name}' 吗？组内 {count} 个代理将移至未分组。"
      },
    },
