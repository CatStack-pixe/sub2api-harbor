export default {
    settings: {
      ...
      heartbeat: {
        title: 'Heartbeat 配置',
        description: '配置 heartbeat 接收、代理自动探测和账号组路由。',
        vaultUrl: 'Vault 地址',
        allowedSourceIps: '来源 IP 白名单',
        allowedSourceIpsPlaceholder: '203.0.113.10, 2001:db8::10',
        allowedSourceIpsHint: '填写精确 IP，使用空格或逗号分隔。',
        allowInsecureVault: '允许 Vault 使用不安全的 HTTP',
        workerCount: '工作线程数',
        proxyProbeWorkers: '代理探测线程数',
        proxyProbeSampleSize: '代理探测样本数',
        proxyProbeTimeout: '代理探测超时（秒）',
        proxySweepTtl: '代理缓存 TTL（秒）',
        maxAttempts: '最大重试次数',
        targetsTitle: '账号组路由',
        targetsDescription: '每个 heartbeat 账号组使用所选代理组进行探测和账号上线。',
        addTarget: '添加映射',
        defaultGroup: '默认账号组',
        selectGroup: '选择账号组',
        noTargets: '请至少添加一个账号组映射。',
        accountGroup: '账号组',
        proxyGroup: '代理组',
        selectProxyGroup: '选择代理组',
        removeTarget: '移除映射',
        statusTitle: '队列概览',
        source: '配置来源',
        refresh: '刷新',
        lastHeartbeat: '最近接收 heartbeat',
        lastError: '最近错误',
        save: '保存 heartbeat 配置',
        saved: 'Heartbeat 配置已保存并立即生效。',
        logsTitle: '分配日志',
        logsDescription: '查看最近的 heartbeat 分配任务、结果与错误信息。',
        logsRefresh: '刷新日志',
        logsLoading: '正在加载日志...',
        logsEmpty: '暂时没有 heartbeat 分配任务。',
        logsProvider: '提供方',
        logsStatus: '状态',
        logsAttempts: '尝试次数',
        logsTargets: '目标',
