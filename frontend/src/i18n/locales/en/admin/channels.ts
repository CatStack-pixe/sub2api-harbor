export default {
    ...
    channels: {
      ...
      form: {
        ...
        timeWindows: 'Time-based price overrides (optional)',
        timeWindowsHint: 'Applied daily in Asia/Shanghai; uncovered times use the default prices.',
        addTimeWindow: 'Add Window',
        startTime: 'Start',
        endTime: 'End',
        minTokens: 'Min',
        maxTokens: 'Max',
