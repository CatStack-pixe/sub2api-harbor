export default {
    settings: {
      ...
      heartbeat: {
        title: 'Heartbeat Provisioning',
        description: 'Configure heartbeat intake, proxy probing, and account group routing.',
        vaultUrl: 'Vault URL',
        allowedSourceIps: 'Allowed source IPs',
        allowedSourceIpsPlaceholder: '203.0.113.10, 2001:db8::10',
        allowedSourceIpsHint: 'Use exact IP addresses separated by spaces or commas.',
        allowInsecureVault: 'Allow insecure HTTP for the Vault endpoint',
        workerCount: 'Worker count',
        proxyProbeWorkers: 'Proxy probe workers',
        proxyProbeSampleSize: 'Proxy probe sample size',
        proxyProbeTimeout: 'Proxy probe timeout (seconds)',
        proxySweepTtl: 'Proxy cache TTL (seconds)',
        maxAttempts: 'Maximum attempts',
        targetsTitle: 'Account group routing',
        targetsDescription: 'Each heartbeat account group uses the selected proxy group for probing and provisioning.',
        addTarget: 'Add mapping',
        defaultGroup: 'Default account group',
        selectGroup: 'Select account group',
        noTargets: 'Add at least one account group mapping.',
        accountGroup: 'Account group',
        proxyGroup: 'Proxy group',
        selectProxyGroup: 'Select proxy group',
        removeTarget: 'Remove mapping',
        statusTitle: 'Queue overview',
        source: 'Configuration source',
        refresh: 'Refresh',
        lastHeartbeat: 'Last accepted heartbeat',
        lastError: 'Last error',
        save: 'Save heartbeat configuration',
        saved: 'Heartbeat configuration saved and applied.',
        logsTitle: 'Provisioning logs',
        logsDescription: 'Recent heartbeat provisioning jobs, outcomes, and errors.',
        logsRefresh: 'Refresh logs',
        logsLoading: 'Loading logs...',
        logsEmpty: 'No heartbeat provisioning jobs yet.',
