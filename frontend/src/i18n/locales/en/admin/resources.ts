export default {
    ...
    proxies: {
      ...
      allProxyGroups: 'All Proxy Groups',
      ungrouped: 'Ungrouped',
      proxyGroup: 'Proxy Group',
      manageGroups: 'Manage Groups',
      batchMove: 'Move',
      batchMoveTitle: 'Move Selected Proxies',
      batchMoveDescription: 'Move {count} selected proxies to a proxy group.',
      batchMoveDone: 'Moved {count} proxies',
      batchMoveFailed: 'Failed to move proxies',
      batchMoveLimit: 'You can move at most 5000 proxies at a time',
      move: 'Move',
      moving: 'Moving...',
      resultLimitHint: 'Showing {shown} of {total} matches. Refine your search to see more.',
      batchTestLimitExceeded: 'Refine the current filters to {count} proxies or fewer before batch testing',
      protocols: {
        http: 'HTTP',
        https: 'HTTPS',
        socks5: 'SOCKS5',
      ...
      proxyGroups: {
        manageTitle: 'Proxy Groups',
        name: 'Group Name',
        namePlaceholder: 'Enter a group name',
        nameRequired: 'Please enter a group name',
        empty: 'No proxy groups yet',
        totalCount: '{count} total',
        activeCount: '{count} active',
        inactiveCount: '{count} inactive',
        created: 'Proxy group created',
        updated: 'Proxy group updated',
        deleted: 'Proxy group deleted; its proxies are now ungrouped',
        createFailed: 'Failed to create proxy group',
        updateFailed: 'Failed to update proxy group',
        deleteFailed: 'Failed to delete proxy group',
        loadFailed: 'Failed to load proxy groups',
        deleteTitle: 'Delete Proxy Group',
        deleteConfirm: "Delete proxy group '{name}'? Its {count} proxies will become ungrouped."
      },
    },
