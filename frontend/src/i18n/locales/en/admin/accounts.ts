export default {
    accounts: {
      ...
      tokenrhythm: {
        ...
        session: 'Sess session key',
        sessionPlaceholder: 'sess_...',
        sessionHint: 'Validates the session through the selected proxy and generates the balance Cookie and referral link. The sess value is not stored.',
        resolveSession: 'Generate Cookie and link',
        resolvingSession: 'Generating',
        sessionResolved: 'TokenRhythm Cookie and referral link generated',
        sessionResolveFailed: 'TokenRhythm sess validation failed',
        inviteLink: 'Referral link',
        inviteLinkOpen: 'Open referral link',
        inviteCode: 'Referral code: {code}',
        ...
        manageKeyHint: 'Create a provider key with a TokenRhythm sess, pasted Cookie, or the saved account credential. The generated key and Cookie are filled into this form; secrets are never listed later.',
        ...
        keyInventory: 'Provider keys',
        keyInventoryHint: 'Only names, status, and masked identifiers are returned.',
        listKeys: 'Load keys',
        loadingKeys: 'Loading',
        noKeys: 'No provider keys were found.',
        unknownStatus: 'Unknown status',
        disableKey: 'Disable',
        working: 'Working',
        disableConfirm: 'Disable provider key "{name}"?',
        deleteConfirm: 'Permanently delete provider key "{name}"?',
        keyListFailed: 'Failed to load TokenRhythm API keys',
        keyActionFailed: 'Failed to update the TokenRhythm API key',
        accountCredentialSource: 'Uses the saved credential for this account unless a new session was resolved.',
        credentialPersistWarning: 'The provider operation succeeded, but the rotated Cookie was not saved automatically. Save this account before continuing.'
      },
      nvidia: {
        baseUrlHint: 'OpenAI-compatible NVIDIA NIM endpoint. The default includes /v1.',
        apiKeyHint: 'Your NVIDIA API Key'
      },
      chatanywhere: {
        baseUrlHint: 'Select the official China or Global ChatAnywhere endpoint.',
