export default {
  ...
  keys: {
    ...
    modelWhitelist: 'Model access restriction',
    modelWhitelistHint: 'Leave empty to allow every model in the group. When configured, only matching models are allowed.',
    modelRestrictionEnabled: 'Model access restriction configured',
    modelRestrictionSelectGroupFirst: 'Select a group first to load its available models.',
    modelRestrictionSelected: '{count} models selected',
    modelRestrictionSelectAll: 'Select all',
    modelRestrictionClear: 'Clear restriction',
    modelRestrictionLoading: 'Loading models available in this group...',
    modelRestrictionLoadFailed: 'Failed to load group models. Please try again.',
    modelRestrictionNoModels: 'This group has no selectable models.',
    modelRestrictionUnavailable: 'Existing selections below are no longer in this group:',
