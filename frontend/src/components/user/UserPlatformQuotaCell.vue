...
const PLATFORM_ORDER: PlatformQuotaPlatform[] = ['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'agnes', 'deepseek', 'kimi', 'zhipu', 'nvidia', 'tokenrhythm', 'chatanywhere', 'glm', 'modelscope', 'dashscope', 'minimax', 'volcengine']
