<template>
  ...
  <!-- Agnes AI mono mark from LobeHub Icons -->
  <svg v-else-if="platform === 'agnes'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  ...
  <!-- DeepSeek mono mark from LobeHub Icons -->
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  ...
  <!-- Kimi moon mark -->
  <svg v-else-if="platform === 'kimi'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor" aria-label="Kimi">
    <path d="M14.95 2.38A9.5 9.5 0 1 0 21.62 15a7.95 7.95 0 1 1-6.67-12.62Z" />
    <path d="M15.75 6.5 16.55 8l1.5.8-1.5.8-.8 1.5-.8-1.5-1.5-.8 1.5-.8.8-1.5Z" />
  </svg>
  <!-- NVIDIA / Nemotron mono mark from LobeHub Icons -->
  <svg v-else-if="platform === 'nvidia'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  ...
  <!-- ModelScope mark -->
  <svg v-else-if="platform === 'modelscope'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M4 17V7l8-4 8 4v10l-8 4-8-4Z" />
    <path d="m8 9 4-2 4 2-4 2-4-2Zm0 4 4 2 4-2" />
  </svg>
  <!-- DashScope / Alibaba mark -->
  <svg v-else-if="platform === 'dashscope'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M6 5h12M6 19h12M8 5v14m8-14v14" />
    <path d="M4 9h16M4 15h16" />
  </svg>
  <!-- MiniMax mark -->
  <svg v-else-if="platform === 'minimax'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="m4 18 4-12 4 12 4-12 4 12" />
  </svg>
  <!-- Volcengine Ark mark -->
  <svg v-else-if="platform === 'volcengine'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
