...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'grok', label: 'Grok' }, { value: 'agnes', label: 'Agnes' }, { value: 'deepseek', label: 'DeepSeek' }, { value: 'nvidia', label: 'NVIDIA' }, { value: 'tokenrhythm', label: 'TokenRhythm' }, { value: 'chatanywhere', label: 'ChatAnywhere' }, { value: 'glm', label: 'GLM' }])
