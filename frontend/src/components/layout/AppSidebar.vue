...
const flagRemoteIngest = makeSidebarFlag(FeatureFlags.remoteIngest)
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/remote-ingest', label: t('nav.remoteIngest'), icon: KeyIcon, featureFlag: flagRemoteIngest },
