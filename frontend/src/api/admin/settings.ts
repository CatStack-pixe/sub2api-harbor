...
// ── 平台限额类型 ──────────────────────────────────────────────────
export type PlatformType = "anthropic" | "openai" | "gemini" | "antigravity" | "grok" | "agnes" | "deepseek" | "kimi" | "zhipu" | "nvidia" | "tokenrhythm" | "tierflow" | "chatanywhere" | "glm" | "modelscope" | "dashscope" | "minimax" | "volcengine" | "sensenova"
...
const PLATFORMS: PlatformType[] = ["anthropic", "openai", "gemini", "antigravity", "grok", "agnes", "deepseek", "kimi", "zhipu", "nvidia", "tokenrhythm", "tierflow", "chatanywhere", "glm", "modelscope", "dashscope", "minimax", "volcengine", "sensenova"]
